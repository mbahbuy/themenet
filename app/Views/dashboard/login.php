...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>
            Login - Layanan IDI Kab. Sidoarjo
        </title>
        <meta name="description" content="Login Layanan IDI Kabupaten Sidoarjo">
        ...
        <link rel="apple-touch-icon" sizes="64x64" href="/assets/idi-sidoarjo/images/idi-icon.png">
        <link rel="icon" type="image/png" sizes="64x64" href="/assets/idi-sidoarjo/images/idi-icon.png">
        <link rel="mask-icon" href="/assets/idi-sidoarjo/images/idi-icon.png" color="#5bbad5">
        <link rel="stylesheet" media="screen, print" href="/assets/smartadmin/css/fa-brands.css">
    </head>
    <body class="">
