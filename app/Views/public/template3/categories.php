...
<?= $this->section('content') ?>
    ...
    <div class="catagory-featured-post bg-overlay clearfix" style="background-image: url(template/theme-4/img/bg-img/23.jpg)">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="template/theme-4/img/bg-img/24.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="template/theme-4/img/bg-img/25.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="template/theme-4/img/bg-img/26.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="template/theme-4/img/bg-img/27.jpg" alt=""></a>
                                            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="template/theme-4/img/bg-img/28.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="template/theme-4/img/bg-img/29.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="template/theme-4/img/bg-img/30.jpg" alt=""></a>
                        </div>
