...
<?= $this->section('content') ?>
    ...
    <!-- ##### Contact Area Start ##### -->
    <div class="hero-contact-area bg-overlay clearfix" style="background-image: url(template/theme-4/img/bg-img/34.jpg)">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-content mb-100">
                        ...
                        <!-- Logo -->
                        <a href="#" class="d-block mb-50"><img src="template/theme-4/img/core-img/logo.png" alt=""></a>

                        <!-- Single Contact Info -->
                        <div class="single-contact-info d-flex align-items-center">
                            <div class="icon mr-15">
                                <img src="template/theme-4/img/core-img/map-pin.png" alt="">
                            </div>
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            <div class="icon mr-15">
                                <img src="template/theme-4/img/core-img/smartphone.png" alt="">
                            </div>
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            <div class="icon mr-15">
                                <img src="template/theme-4/img/core-img/paper-plane.png" alt="">
                            </div>
